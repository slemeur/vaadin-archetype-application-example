package com.codenvy.client.samples;
...
import com.codenvy.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.codenvy.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
