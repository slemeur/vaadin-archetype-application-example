...
- vaadin-archetype-application-example-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadin-archetype-application-example-ui: main application module, development time
- vaadin-archetype-application-example-production: module that produces a production mode WAR for deployment
